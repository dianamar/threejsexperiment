...
THREEx.Terrain.heightToColor	= (function(){
	...
	return function(height){
		...
		if( height < 0.5 ){
			...
			// bleu color.setRGB(0,height*0.8, height*0.8)
			color.setRGB(height*0.45,height*0.45, height*0.45)
		}else if( height < 0.7 ){
			height		= (height-0.5)/0.2
			height		= height*0.5 + 0.2
			color.setRGB(height*0.45,height*0.45, height*0.45)
			// bleu color.setRGB(0,height, 0)
			//color.setRGB(0,height*1.8, height*1.8)
		}else{
